      ...
      <main className="relative">
        ...
        <section className="relative pt-32 pb-8 px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <a
              href="/articles"
              className="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-[#DEDBC8] transition-colors"
            >
              ...
              {articles
                ...
                .map((related) => (
                  <a
                    ...
                    className="bg-[#101010] rounded-lg p-6 hover:bg-[#1a1a1a] transition-colors group"
                  >
