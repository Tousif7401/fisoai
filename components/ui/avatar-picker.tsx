...
export function AvatarPicker({
    ...
    return (
        <motion.div initial="initial" animate="animate" className="w-full font-['Almarai']">
            <Card className="w-full max-w-md mx-auto overflow-hidden bg-[#1F2023] border-0 shadow-none">
                <CardContent className="p-0">
                    ...
                    <motion.div
                        ...
                        className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 w-full"
                    />
                                ...
                                {avatars.map((avatar) => (
                                    <motion.button
                                        ...
                                        className={cn(
                                            ...
                                            "transition-all duration-300 bg-[#1F2023]"
                                        )}
                                        variants={pickerVariants.item}
                                        whileHover={{
                                            y: -2,
                                    ...
                                    >
                                        ...
                                        {selectedAvatar.id === avatar.id && (
                                            <motion.div
                                                className="absolute inset-0 bg-purple-500/30 ring-2 ring-purple-500 rounded-full"
